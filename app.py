...
crop_xgb_pipeline = pickle.load(
    open("C:/Users/ADMIN/Desktop/AgriAIc/Flask_API/models/crop_recommendation/xgb_pipeline.pkl", "rb")

)
crop_rf_pipeline = pickle.load(
    open("C:/Users/ADMIN/Desktop/AgriAIc/Flask_API/models/crop_recommendation/rf_pipeline.pkl", "rb")
)
crop_knn_pipeline = pickle.load(
    open("C:/Users/ADMIN/Desktop/AgriAIc/Flask_API/models/crop_recommendation/knn_pipeline.pkl", "rb")
)
crop_label_dict = pickle.load(
    open("C:/Users/ADMIN/Desktop/AgriAIc/Flask_API/models/crop_recommendation/label_dictionary.pkl", "rb")
)
